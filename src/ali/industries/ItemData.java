...
public class ItemData {
    ...
    public static Armor ruestunglvl2 = new Armor("Kettenhemd", 0.5, 5, 10);
    public static Armor ruestunglvl3 = new Armor("Stahlruestung", 0.25, 6, 20);
    public static Armor none = new Armor("Keine",1,7,0);
}
